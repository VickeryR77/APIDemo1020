...
namespace AngularAPIWalkthrough.Models
{
    public class Employee
    {
        ...
        //Long Matches Better
        //? means it can be any number or null
        ...
        //Needs to be established the same here
        //Search function to mimic SELECT WHERE ID = something
